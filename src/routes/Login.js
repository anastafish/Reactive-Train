...
import {  TextField, Button, Alert, Switch, MenuItem, Select } from '@mui/material';
             ...
             severity="warning"
              ...
              <div className='bg-white bg-opacity-95 rounded-lg p-5
                ...
                <div className='flex flex-col gap-2 w-[100%]'>
                    <TextField autoFocus name='email' value={loginInfo.email} onChange={handleChange} label={t('email_address')} type='email'/>
                    <TextField name='password' value={loginInfo.password} onChange={handleChange} label={t('password')} type='password'/>
                </div>

                <Button color='warning' variant="contained" onClick={login}>{t('login')}</Button>
                <Link to={'/'}>
