...
function Tickets() {
  ...
  return (
    ...
    className='flex flex-col p-2 items-center h-[100vh] w-[100vw]'>
        <Nav />
          <h1 className='sm:text-[70px] text-center text-[30px]'>{t('your_tickets')}</h1>
          <div className='flex flex-col gap-5 p-5 sm:w-[80%] w-full items-center overflow-y-scroll scrol'>
